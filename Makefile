...
mainfile.o:mainfile.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) -dc $(GENCODE_FLAGS) $(CDEFINES) -o $@ -c $<

kernels.o:kernels.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) -dc $(GENCODE_FLAGS) $(CDEFINES) -o $@ -c $<

stdafx.o:vkcomp/stdafx.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) -dc $(GENCODE_FLAGS) $(CDEFINES) -o $@ -c $<

mainfile: mainfile.o kernels.o stdafx.o
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) $(CDEFINES) -o $@ $+ $(LIBRARIES)

run: build
	$(EXEC) ./mainfile

clean:
	rm -f mainfile mainfile.o kernels.o stdafx.o
